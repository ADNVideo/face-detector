        ...
        if(video.ReadFrame(image)) {		
            ...
            for(size_t i = 0; i < detections.size(); i++) {
                ...
                if (show & score>threshold) {
					...
					std::cout << "    <time>"<< video.GetTime()<<"</time>"<<std::endl;
					std::cout << "    <positionX>"<< detections[i].x<<"</positionX>"<<std::endl;
					std::cout << "    <positionY>"<< detections[i].y<<"</positionY>"<<std::endl;
					std::cout << "    <width>"<< detections[i].width<<"</width>"<<std::endl;
					std::cout << "    <height>"<< detections[i].height<<"</height>"<<std::endl;
					std::cout << "    <confidence>"<< score<<"</confidence>"<<std::endl;					
					std::cout << "</face>"<<std::endl;
